...
Built entirely from scratch, including core architecture implementations (Rotary Position Embeddings, RMSNorm, custom attention layers) for models like Qwen, LLaMA, and more to come.
